            ...
            <div className="contacts__list">
              <div className="contacts__item">
                ...
                <div className="contacts__text">
                  ...
                  <a
                    ...
                    href="mailto:customercare@hygge.com"
                  >
              ...
              <div className="contacts__item">
                ...
                <div className="contacts__text">
                  ...
                  <a className="contacts__link" href="mailto:media@hygge.com">
                    media@hygge.com
                  </a>
                </div>
              </div>
              <div className="contacts__item">
                ...
                <div className="contacts__text">
                  ...
                  <a className="contacts__link" href="mailto:sales@hygge.com">
                    sales@hygge.com
                  </a>{' '}
              ...
              <div className="contacts__item">
                ...
                <div className="contacts__text">
                  ...
                  <a className="contacts__link" href="mailto:general@hygge.com">
                    general@hygge.com
                  </a>
                </div>
              </div>
