...
!(function (a, b) {
    ...
    (r.extend = r.fn.extend = function () {
      ...
      for (
        'boolean' == typeof g && ((j = g), (g = arguments[h] || {}), h++),
          'object' == (typeof g === 'undefined' ? 'undefined' : _typeof(g)) ||
            r.isFunction(g) ||
            (g = {}),
          h === i && ((g = this), h--);
        i > h;
      ...
      var c = b.length > 0,
        ...
        f = function f(_f, g, h, i, k) {
          ...
          if (((r += s), c && s !== r)) {
            ...
            G.apply(i, u),
              k && !_f && u.length > 0 && r + b.length > 1 && ga.uniqueSort(i);
          }
          return k && ((w = y), (j = v)), t;
        };
      return c ? ia(f) : f;
        ...
        3 !== e.nodeType &&
          ...
          (b = b[r.expando]
            ...
            : new r.Event(
                p,
                'object' ==
                  (typeof b === 'undefined' ? 'undefined' : _typeof(b)) && b
              )),
          (b.isTrigger = f ? 2 : 3),
          (b.namespace = q.join('.')),
  ...
  r.extend({
    ...
    ajax: function ajax(b, c) {
      'object' == (typeof b === 'undefined' ? 'undefined' : _typeof(b)) &&
        ((c = b), (b = void 0)),
        (c = c || {});
      var e,
        f,
...
!(function (i) {
  ...
  ((e = (function () {
    ...
    (i.fn.slick = function () {
      ...
      for (i = 0; i < r; i++) {
        if (
          ('object' == (typeof s === 'undefined' ? 'undefined' : _typeof(s)) ||
          void 0 === s
...
(function ($, window, document) {
  var EZP = {
    init: function init(options, elem) {
      ...
      self.imageSrc = self.$elem.attr('data-' + self.options.attrImageZoomSrc)
        ? self.$elem.attr('data-' + self.options.attrImageZoomSrc)
        : self.$elem.attr('src');
      ...
      self.$galleries.on(galleryEvent, self.options.galleryItem, function (e) {
        ...
        if (self.options.galleryActiveClass) {
          $(self.options.galleryItem, self.$galleries).removeClass(
    ...
    startZoom: function startZoom() {
      ...
      if (self.$elem.attr('id')) {
        self.zoomContainer.attr(
          'id',
          self.$elem.attr('id') + '-' + self.options.container
        );
      }
      ...
      self.zoomContainer.add(self.$elem).hover(
        function () {
          if (self.overWindow === false) {
            self.setElements('show');
          }
    ...
    setPosition: function setPosition(e) {
      ...
      self.mouseLeft = parseInt(
        e.pageX - self.pageOffsetX - self.nzOffset.left
      );
      ...
      //else continue with operations
        ...
        if (self.options.showLens) {
          ...
          self.lensLeftPos = Math.floor(
            self.mouseLeft - self.zoomLens.width() / 2
          );
          self.lensTopPos = Math.floor(
            self.mouseTop - self.zoomLens.height() / 2
          );
        }
        ...
        if (self.options.zoomType === 'lens') {
          self.windowLeftPos =
            ...
            -1;
          self.windowTopPos =
            ((e.pageY - self.pageOffsetY - self.nzOffset.top) *
              self.heightRatio -
    ...
    setWindowPosition: function setWindowPosition(e) {
      ...
      self.windowLeftPos =
        ((e.pageX - self.pageOffsetX - self.nzOffset.left) * self.widthRatio -
          self.zoomWindow.width() / 2) *
        -1;
      self.windowTopPos =
        ((e.pageY - self.pageOffsetY - self.nzOffset.top) * self.heightRatio -
      ...
      if (
        ...
        if (self.options.easing) {
          ...
          if (
            typeof easingInterval === 'number' &&
            isFinite(easingInterval) &&
            Math.floor(easingInterval) === easingInterval
          ) {
    ...
    setTintPosition: function setTintPosition(e) {
      ...
      self.updateOffset(self);
      self.tintpos =
        (e.pageX - self.pageOffsetX - self.nzOffset.left - zoomLensWidth / 2) *
        -1;
      self.tintposy =
        (e.pageY - self.pageOffsetY - self.nzOffset.top - zoomLensHeight / 2) *
        -1;
      if (self.Etoppos) {
        self.tintposy = 0;
      }
